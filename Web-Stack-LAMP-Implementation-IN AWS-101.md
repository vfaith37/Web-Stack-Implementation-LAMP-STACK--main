...
![Launch](./LAMP-in-AWS-101/Image/Lunch_instance.png)
![Lunch_instance-2](./LAMP-in-AWS-101/Image/Lunch_instance-2.png)
...
![Launch_instance-3](./LAMP-in-AWS-101/Image/Launch_instance-3.png)
...
![Terminal-1](./LAMP-in-AWS-101/Image/Terminal-1.png)
...
![Terminal-2](./LAMP-in-AWS-101/Image/Terminal-2.png)
![Terminal-3](./LAMP-in-AWS-101/Image/Terminal%203.png)

__2.__ __Run apache2 package installation__
```
sudo apt install apache2 
```
![Terminal-4](./LAMP-in-AWS-101/Image/Terminal-4.png)
...
![Termainal-5](./LAMP-in-AWS-101/Image/Terminal-5.png)
...
```
![Termainal-6](./LAMP-in-AWS-101/Image/Terminal-6.png)
...
```
![default-page](./LAMP-in-AWS-101/Image/defualt-page.png)
...
```
![Terminal](./LAMP-in-AWS-101/Image/Terminals-7.png)
...
```
![Termainal-8](./LAMP-in-AWS-101/Image/Terminal-8.png)
...
![Terminal-9](./LAMP-in-AWS-101/Image/Terminal-9.png)
...
```
![Terminal](./LAMP-in-AWS-101/Image/Terminal-10.png)
...
sudo mysql -p
```
![Terminal-11](./LAMP-in-AWS-101/Image/Terminal-11.png)
...
```
![Terminal-12](./LAMP-in-AWS-101/Image/Terminal-12.png)

Confirm the PHP version
```
php -v
```
![Termianl-13](./LAMP-in-AWS-101/Image/Terminal-13.png)
...
```
![Terminal-14](./LAMP-in-AWS-101/Image/Terminal-14.png)
...
```
![Terminal-15](./LAMP-in-AWS-101/Image/Terminal-15.png)
...
```
![Terminal](./LAMP-in-AWS-101/Image/Terminal-16.png)
...
```
![Terminal-17](./LAMP-in-AWS-101/Image/Terminal-17.png)
![Enable virtual host](./LAMP-in-AWS-101/Image/defualt-page.png)
...
```
![Terminal-18](./LAMP-in-AWS-101/Image/Terminal-18.png)
...
```
![Terminal-19](./LAMP-in-AWS-101/Image/Terminal-19.png)
...
```
![Terminal](./LAMP-in-AWS-101/Image/Terminal-20.png)
...
phpinfo();
```
![Terminal-21](./LAMP-in-AWS-101/Image/Terminal-21.png)


__4.__ __Now refresh the page__
![php-01](./LAMP-in-AWS-101/Image/Php01.png)
